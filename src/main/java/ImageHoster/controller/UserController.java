...
public class UserController {
    ...
    public String registerUser(User user, RedirectAttributes redirectAttrs) {
        /*
        * This condition was put in place to use the isPasswordStrong() function to verify whether the
        * current password has been verified as a strong password to register with
        *  */
    ...
    /*
    * I find isPasswordStrong() a unique function to practice a familiar topic known as Regular Expressions in Java
    * This function checks for at least 1 alphabet, number and special character to verify a good password to register
    * */
